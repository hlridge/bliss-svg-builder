...
- **Sky line** (y=8) — top of the main content area
- **Earth line** (y=16) — bottom of the main content area
...
<Demo code="[grid=1;crop=auto-vertical]||C8:0,8;DOT:2,10;DOT:6,10;HC4S:4,13" title="Custom smiley using grid reference" />
