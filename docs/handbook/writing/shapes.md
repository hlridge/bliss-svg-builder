...
<Demo code="[grid=1;crop=auto-height]||C8:0,8;DOT:2,11;DOT:6,11;HC4S:4,14" title="Custom smiley (no B-code exists)" />
...
<Demo code="[grid=1;crop=auto-height]||C8:0,8" title="C8 - circle, 8 units" />

<Demo code="[grid=1;crop=auto-height]||C4:0,8" title="C4 - circle, 4 units" />

<Demo code="[grid=1;crop=auto-height]||C2:0,8" title="C2 - circle, 2 units" />

### Direction Suffixes

`N`, `S`, `E`, `W`, `NE`, `SE`, `SW`, `NW` indicate orientation:

<Demo code="[grid=1;crop=auto-height]||HC8N:0,8" title="HC8N - half circle, opening north" />

<Demo code="[grid=1;crop=auto-height]||HC8S:0,8" title="HC8S - half circle, opening south" />

<Demo code="[grid=1;crop=auto-height]||AN:0,8" title="AN - arrow pointing north" />

<Demo code="[grid=1;crop=auto-height]||DL8NE:0,8" title="DL8NE - diagonal line, northeast" />

### Combined Patterns

Some shapes use both size and direction:

<Demo code="[grid=1;crop=auto-height]||QC4NE:0,8" title="QC4NE - quarter circle, 4 units, northeast" />

<Demo code="[grid=1;crop=auto-height]||QC4SW:0,8" title="QC4SW - quarter circle, 4 units, southwest" />
...
<Demo code="[grid=1;crop=auto-height]||C8:0,8" title="Circle at (0,8)" />

<Demo code="[grid=1;crop=auto-height]||C8:4,8" title="Circle at (4,8) - shifted right" />

<Demo code="[grid=1;crop=auto-height]||C8:0,12" title="Circle at (0,12) - shifted down" />
...
<Demo code="[grid=1;crop=auto-height]||VL8:0,8;VL8:8,8;HL8:0,8;HL8:0,16" title="Rectangle from lines" />

<Demo code="[grid=1;crop=auto-height]||C8:0,8;DOT:2,10;DOT:6,10;HC4S:4,13" title="Smiley face" />

Each shape is positioned independently. Enable `grid=1` to visualize the coordinate system.

### The `crop=auto-height` Option

When building with shapes directly, use `crop=auto-height` to fit the SVG height to the actual content instead of the fixed 20-unit grid:

```
[crop=auto-height]||C8:0,8;DOT:4,12
```
